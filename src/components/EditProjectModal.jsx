...
// El padre debe pasar key={project.id} para forzar remount al cambiar proyecto
export function EditProjectModal({ isOpen, onClose, onSave, project }) {
  ...
  const inputClass =
    'border border-gray-300 py-3 px-4 rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-blue-300 bg-white';
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <h3 className="text-lg font-bold text-blue-700">Editar Proyecto</h3>
          <button
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-5 py-5 overflow-y-auto max-h-[75dvh]">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Fecha de inicio</label>
            <input
              type="date"
              value={fechaInicio}
